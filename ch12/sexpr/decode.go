...
type lexer struct {
	...
	token rune // the current token // 当前token
}
...
func (lex *lexer) consume(want rune) {
	if lex.token != want { // NOTE: Not an example of good error handling. // // 注意：这不是很好的错误处理示例。
...
func readList(lex *lexer, v reflect.Value) {
	...
	default:
		panic(fmt.Sprintf("connot decode list into %v", v.Type()))
	}
}
